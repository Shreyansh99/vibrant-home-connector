      ...
      <div className="container max-w-7xl mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12 mb-12">
          <div className="col-span-1 md:col-span-1">
            <h2 className="text-2xl font-display font-bold mb-4">Aesthetic</h2>
            <p className="text-muted-foreground mb-4">
              Beautiful design that respects both form and function, creating experiences that delight and serve.
            </p>
            <div className="flex gap-4">
              <a href="#" className="w-8 h-8 rounded-full bg-secondary flex items-center justify-center text-foreground hover:bg-primary hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">Design Systems</a></li>
            </ul>
          </div>
