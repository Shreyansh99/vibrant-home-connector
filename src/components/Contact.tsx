    ...
    <section id="contact" className="py-24 md:py-32 bg-secondary/50 relative overflow-hidden">
      ...
      <div className="container max-w-7xl mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="inline-block px-3 py-1 mb-4 text-xs font-medium bg-white rounded-full text-foreground/70">
              Get in Touch
            </div>
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-lg">
              Have a project in mind? We'd love to hear about it. Let's discuss how we can help bring your vision to life with our design expertise.
            </p>
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">hello@aesthetic.design</p>
                </div>
              </div>
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-foreground hover:bg-primary hover:text-white transition-colors">
